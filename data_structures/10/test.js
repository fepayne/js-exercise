describe("findNeedle", function() {
    ...
    it("takes an array full of junk and return index of 'needle'", function() {
        ...
        assert.equal(findNeedle(haystack_1), 'found the needle at position 3');
        assert.equal(findNeedle(haystack_2), 'found the needle at position 5');
        assert.equal(findNeedle(haystack_3), 'found the needle at position 30');
    });
